...
public class a
{
  ...
  public List<Map<String, String>> a(Conditions paramConditions)
  {
    ...
    str = SqlTool.buildConditions("and", new String[] { str, SqlTool.buildInCondition("domain", localObject), SqlTool.buildInCondition("language", arrayOfString2), SqlTool.buildInCondition("quality", arrayOfString3), SqlTool.buildInCondition("gender", arrayOfString4), SqlTool.buildInCondition("speaker", arrayOfString5), SqlTool.buildInCondition("id", paramConditions) });
    if (StringTool.isEmpty(str))
      return null;
    return (List<Map<String, String>>)b("select * from speechModel where " + str, DataTool.connect(arrayOfString1, new String[][] { localObject, arrayOfString2, arrayOfString3, arrayOfString4, arrayOfString5, paramConditions }));
  }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    try
    {
      ...
      try
      {
        localSQLiteDatabase.execSQL("replace into fsFileInfo (absPath,state) values (?, ?)", new String[] { paramString, String.valueOf(paramInt) });
 ...
 * Qualified Name:     com.baidu.tts.database.a
