...
public class AsyncHttpClient
{
    ...
    while (true)
    {
      ...
      this.httpClient.addRequestInterceptor(new HttpRequestInterceptor()
      {
        public void process(HttpRequest paramHttpRequest, HttpContext paramHttpContext)
        {
          ...
          paramHttpContext = AsyncHttpClient.this.clientHeaderMap.keySet().iterator();
          while (paramHttpContext.hasNext())
          {
            ...
            if (paramHttpRequest.containsHeader(str))
            {
              ...
              AsyncHttpClient.log.d("AsyncHttpClient", String.format("Headers were overwritten! (%s | %s) overwrites (%s | %s)", new Object[] { str, AsyncHttpClient.access$000(AsyncHttpClient.this).get(str), localHeader.getName(), localHeader.getValue() }));
              paramHttpRequest.removeHeader(localHeader);
            }
            paramHttpRequest.addHeader(str, (String)AsyncHttpClient.this.clientHeaderMap.get(str));
          }
        }
      });
  ...
  public static void endEntityViaReflection(HttpEntity paramHttpEntity)
  {
    ...
    while (true)
    {
      ...
      catch (java.lang.Throwable paramHttpEntity)
      {
  ...
  public void cancelRequests(Context paramContext, boolean paramBoolean)
  {
    ...
    {
      paramContext = new Runnable(localList, paramBoolean)
      {
        public void run()
        {
  ...
  {
    label17: Iterator localIterator;
    if (paramObject == null)
    {
    ...
    while (true)
    {
      ...
      synchronized (this.requestMap)
      {
        ...
        while (paramDefaultHttpClient.hasNext())
        {
          ...
          continue;
          label278: paramHttpUriRequest.setHeader("Content-Type", ???);
        }
      }
    }
 ...
 * Qualified Name:     com.baidu.tts.loopj.AsyncHttpClient
