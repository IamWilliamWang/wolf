  ...
  implements ResponseHandlerInterface
{
        ...
        try
        {
          while (true)
          {
            ...
            try
            {
              ...
              long l1 = 0L;
              label74: i = localInputStream.read(arrayOfByte);
  ...
  protected void handleMessage(Message paramMessage)
  {
    try
    {
      ...
      case 0:
        ...
        {
          onSuccess(((Integer)paramMessage[0]).intValue(), (Header[])(Header[])paramMessage[1], (byte[])(byte[])paramMessage[2]);
          return;
        }
      case 1:
      case 2:
    ...
    {
      onFailure(((Integer)paramMessage[0]).intValue(), (Header[])(Header[])paramMessage[1], (byte[])(byte[])paramMessage[2], (Throwable)paramMessage[3]);
      return;
    }
  ...
  public void onProgress(long paramLong1, long paramLong2)
  {
    ...
    double d;
    if (paramLong2 > 0L)
      d = paramLong1 * 1.0D / paramLong2 * 100.0D;
    while (true)
    {
 ...
 * Qualified Name:     com.baidu.tts.loopj.AsyncHttpResponseHandler
