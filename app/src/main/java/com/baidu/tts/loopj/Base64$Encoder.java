    ...
    while (true)
    {
      ...
      while (true)
      {
        ...
        while (true)
        {
          ...
          if (paramBoolean)
          {
            ...
            if (paramInt1 - this.tailLen == n - 2)
              if (this.tailLen > 1)
              {
                ...
                k = paramInt1;
                paramInt1 = m;
                label713: if (this.tailLen <= 0)
                  break label894;
                k = this.tail[paramInt1];
                paramInt1 += 1;
                label732: i = (k & 0xFF) << 2 | (i & 0xFF) << 10;
                this.tailLen -= paramInt1;
                paramInt1 = paramInt2 + 1;
          ...
          label1086: paramInt2 = k;
        }
        label1092: k = paramInt2;
        paramInt2 = i;
        paramInt1 = j;
        j = k;
      }
 ...
 * Qualified Name:     com.baidu.tts.loopj.Base64.Encoder
