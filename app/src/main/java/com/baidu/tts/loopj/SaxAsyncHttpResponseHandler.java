...
public abstract class SaxAsyncHttpResponseHandler<T extends DefaultHandler> extends AsyncHttpResponseHandler
{
  ...
  public native abstract void onFailure(int paramInt, Header[] paramArrayOfHeader, T paramT);
  ...
  public native abstract void onSuccess(int paramInt, Header[] paramArrayOfHeader, T paramT);
 ...
 * Qualified Name:     com.baidu.tts.loopj.SaxAsyncHttpResponseHandler
