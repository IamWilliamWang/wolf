...
public class OfflineAuthNotificationInterceptor extends AInterceptor
{
  ...
  protected Object a(Object paramObject, Method paramMethod, Object[] paramArrayOfObject)
  {
    ...
    if (paramObject.q())
    {
      paramMethod = paramObject.getMode();
      if (paramMethod == null)
      {
        paramObject.p();
      ...
      paramArrayOfObject = paramObject.getTtsParams();
      if (paramArrayOfObject != null)
        return a(paramObject, paramArrayOfObject, paramMethod);
      paramObject.p();
      return AInterceptorHandler.END;
    }
    paramObject.p();
 ...
 * Qualified Name:     com.baidu.tts.aop.tts.OfflineAuthNotificationInterceptor
