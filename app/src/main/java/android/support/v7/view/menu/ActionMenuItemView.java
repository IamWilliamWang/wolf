...
public class ActionMenuItemView extends ap
  implements w, n, View.OnClickListener, View.OnLongClickListener
{
  private j a;
  ...
  public ActionMenuItemView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    paramContext = paramContext.obtainStyledAttributes(paramAttributeSet, k.ActionMenuItemView, paramInt, 0);
    this.i = paramContext.getDimensionPixelSize(k.ActionMenuItemView_android_minWidth, 0);
  ...
  private void e()
  {
    ...
    label75: for (CharSequence localCharSequence = this.b; ; localCharSequence = null)
    {
  ...
  public void a(j paramj, int paramInt)
  {
    ...
    for (paramInt = 0; ; paramInt = 8)
    {
      ...
      if ((paramj.hasSubMenu()) && (this.e == null))
        this.e = new b(this);
      return;
    }
  }
