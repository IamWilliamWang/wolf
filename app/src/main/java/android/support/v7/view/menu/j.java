  ...
  implements b
{
  ...
  private int q = 0;
  private View r;
  private android.support.v4.h.j s;
  private am t;
  ...
  public b a(am paramam)
  {
    this.t = paramam;
    return this;
  }

  public b a(android.support.v4.h.j paramj)
  {
    if (this.s != null)
      this.s.f();
    this.r = null;
  ...
  public android.support.v4.h.j a()
  {
    return this.s;
  }

  CharSequence a(w paramw)
  {
    if ((paramw != null) && (paramw.a()))
  ...
  {
    this.m = paramz;
    paramz.setHeaderTitle(getTitle());
  }
  ...
  public Drawable getIcon()
  {
    ...
    if (this.k != 0)
    {
      Drawable localDrawable = ac.a().a(this.l.d(), this.k);
      this.k = 0;
