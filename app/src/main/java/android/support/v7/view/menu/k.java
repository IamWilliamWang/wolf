  ...
  implements MenuItem
{
  ...
  l a(ActionProvider paramActionProvider)
  {
    return new l(this, this.a, paramActionProvider);
  }
  ...
  public MenuItem setActionView(int paramInt)
  {
    ...
    if ((localView instanceof CollapsibleActionView))
      ((b)this.b).setActionView(new m(localView));
    return this;
  }
  ...
  public MenuItem setOnActionExpandListener(MenuItem.OnActionExpandListener paramOnActionExpandListener)
  {
    ...
    for (paramOnActionExpandListener = new n(this, paramOnActionExpandListener); ; paramOnActionExpandListener = null)
    {
  ...
  public MenuItem setOnMenuItemClickListener(MenuItem.OnMenuItemClickListener paramOnMenuItemClickListener)
  {
    ...
    for (paramOnMenuItemClickListener = new o(this, paramOnMenuItemClickListener); ; paramOnMenuItemClickListener = null)
    {
