...
public class bh extends ListView
{
  ...
  public int a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    ...
    if ((paramInt3 > 0) && (localObject != null))
    {
      ...
      label180: localView.measure(paramInt1, n);
      localView.forceLayout();
      if (j <= 0)
        break label314;
      paramInt2 += paramInt3;
    }
    label259: label309: label311: label314: 
    while (true)
    {
  ...
  public void setSelector(Drawable paramDrawable)
  {
    ...
    for (Object localObject = new bi(paramDrawable); ; localObject = null)
    {
      this.i = ((bi)localObject);
