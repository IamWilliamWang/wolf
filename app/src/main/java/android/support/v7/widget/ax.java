...
public class ax
{
  ...
  private final bc A = new bc(this, null);
  private Runnable B;
  ...
  private final bg x = new bg(this, null);
  private final bf y = new bf(this, null);
  private final be z = new be(this, null);
  ...
  public ax(Context paramContext, AttributeSet paramAttributeSet, int paramInt1, int paramInt2)
  {
    this.d = paramContext;
    this.C = new Handler(paramContext.getMainLooper());
    TypedArray localTypedArray = paramContext.obtainStyledAttributes(paramAttributeSet, k.ListPopupWindow, paramInt1, paramInt2);
    this.j = localTypedArray.getDimensionPixelOffset(k.ListPopupWindow_android_dropDownHorizontalOffset, 0);
    this.k = localTypedArray.getDimensionPixelOffset(k.ListPopupWindow_android_dropDownVerticalOffset, 0);
    if (this.k != 0)
      this.m = true;
    localTypedArray.recycle();
    this.e = new aj(paramContext, paramAttributeSet, paramInt1);
  ...
  private int b()
  {
    ...
    if (this.g == null)
    {
      ...
      {
        bool1 = true;
        this.g = new ay((Context)localObject2, bool1);
        if (this.u != null)
        ...
        this.g.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
        {
          public void onItemSelected(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
          {
            if (paramInt != -1)
            {
              paramAdapterView = ax.a(ax.this);
              if (paramAdapterView != null)
                ay.a(paramAdapterView, false);
            }
          }
        ...
        default:
          ...
          i2 = this.i;
          i1 = -2147483648;
          label269: localView.measure(View.MeasureSpec.makeMeasureSpec(i2, i1), 0);
    ...
    while (true)
    {
      ...
      while (true)
      {
        label325: localObject1 = this.e.getBackground();
  ...
  public void c()
  {
    ...
    x.a(this.e, this.l);
    int i2;
    label64: PopupWindow localPopupWindow;
    if (this.e.isShowing())
    {
      int i3;
      label85: label99: View localView;
      int i5;
      int i6;
      if (this.i == -1)
      {
      ...
      while (true)
      {
        ...
        label223: i3 = 0;
        break label85;
        label228: localPopupWindow = this.e;
        if (this.i == -1);
        for (i3 = -1; ; i3 = 0)
        {
          localPopupWindow.setWidth(i3);
    ...
    {
      i2 = -1;
      label299: if (this.h != -1)
        break label468;
      i1 = -1;
      label309: this.e.setWidth(i2);
      this.e.setHeight(i1);
      b(true);
      localPopupWindow = this.e;
      if ((this.p) || (this.o))
    ...
    while (true)
    {
      ...
      x.a(this.e, e(), this.j, this.k, this.n);
  ...
  public void h(int paramInt)
  {
    ...
    {
      ay.a(localay, false);
      localay.setSelection(paramInt);
      if ((Build.VERSION.SDK_INT >= 11) && (localay.getChoiceMode() != 0))
        localay.setItemChecked(paramInt, true);
    }
  }
