...
public class SearchView extends av
  implements b
{
  static final bo a;
  ...
  private void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      if (TextUtils.isEmpty(this.c.getText()))
        break label123;
      bool1 = true;
      label33: this.f.setVisibility(i1);
      b(bool1);
      View localView = this.d;
      if (!paramBoolean)
        break label129;
      i1 = 8;
      label60: localView.setVisibility(i1);
      i1 = i2;
      ...
      label87: this.j.setVisibility(i1);
      i();
      if (bool1)
        break label139;
    }
    label129: label134: label139: for (paramBoolean = bool2; ; paramBoolean = false)
    {
      c(paramBoolean);
      h();
      return;
  ...
  private boolean e()
  {
    ...
    while (true)
    {
      ...
      return i1;
      label69: if (!this.H.getVoiceSearchLaunchRecognizer())
        continue;
      localIntent = this.o;
    }
  }
  ...
  private void i()
  {
    ...
    {
      localDrawable.setState(localObject);
      return;
      i1 = 0;
      break;
      i2 = 0;
  ...
  private void l()
  {
    ...
    if (this.H.getSuggestAuthority() != null)
    {
      this.x = new bt(getContext(), this, this.H, this.M);
      this.c.setAdapter(this.x);
      bt localbt = (bt)this.x;
      i1 = i2;
      if (this.A)
        i1 = 2;
      localbt.a(i1);
  ...
  {
    paramParcelable = (bs)paramParcelable;
  ...
  {
    bs localbs = new bs(super.onSaveInstanceState());
    localbs.a = c();
    return localbs;
  }
  ...
  public void setOnCloseListener(bp parambp)
  {
    this.r = parambp;
  }
  ...
  public void setOnQueryTextListener(bq parambq)
  {
    this.q = parambq;
  }
  ...
  public void setOnSuggestionListener(br parambr)
  {
    this.t = parambr;
  }
  ...
  public void setSuggestionsAdapter(e parame)
  {
    this.x = parame;
    this.c.setAdapter(this.x);
  }
