...
abstract class a extends ViewGroup
{
  ...
  protected void onConfigurationChanged(Configuration paramConfiguration)
  {
    ...
    TypedArray localTypedArray = getContext().obtainStyledAttributes(null, k.ActionBar, android.support.v7.b.b.actionBarStyle, 0);
    setContentHeight(localTypedArray.getLayoutDimension(k.ActionBar_height, 0));
