...
public class ButtonBarLayout extends LinearLayout
{
  ...
  public ButtonBarLayout(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    paramContext = paramContext.obtainStyledAttributes(paramAttributeSet, k.ButtonBarLayout);
    this.a = paramContext.getBoolean(k.ButtonBarLayout_allowStacking, false);
  ...
  private void setStacked(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      i = 5;
      setGravity(i);
      localView = findViewById(f.spacer);
      if (localView != null)
        if (!paramBoolean)
          break label84;
    }
      ...
      if (this.a)
      {
        ...
        if (!a())
        {
          if (Build.VERSION.SDK_INT < 11)
            break label160;
          j = m;
          if ((bi.e(this) & 0xFF000000) == 16777216)
            j = 1;
        }
      }
    }
