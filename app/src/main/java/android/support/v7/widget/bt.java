  ...
  implements View.OnClickListener
{
  ...
  public bt(Context paramContext, SearchView paramSearchView, SearchableInfo paramSearchableInfo, WeakHashMap<String, Drawable.ConstantState> paramWeakHashMap)
  {
  ...
  private static String a(Cursor paramCursor, int paramInt)
  {
    ...
    catch (java.lang.Exception paramCursor)
    {
  ...
  public View a(Context paramContext, Cursor paramCursor, ViewGroup paramViewGroup)
  {
    ...
    paramContext.setTag(new bu(paramContext));
    ((ImageView)paramContext.findViewById(f.edit_query)).setImageResource(this.o);
    return paramContext;
  }
  ...
  {
    paramContext = (bu)paramView.getTag();
    if (this.x != -1);
    for (int i = paramCursor.getInt(this.x); ; i = 0)
    {
      ...
      while (true)
      {
        ...
        return;
        label215: paramView = a(paramCursor, this.t);
        break;
        label227: if (paramContext.a == null)
          continue;
        paramContext.a.setSingleLine(true);
        paramContext.a.setMaxLines(1);
      }
      label253: paramContext.e.setVisibility(8);
      return;
    }
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    catch (RuntimeException paramView)
    {
      ...
      if (paramViewGroup != null)
        ((bu)paramViewGroup.getTag()).a.setText(paramView.toString());
    }
