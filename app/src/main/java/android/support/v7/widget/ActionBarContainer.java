...
public class ActionBarContainer extends FrameLayout
{
  ...
  public ActionBarContainer(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    if (Build.VERSION.SDK_INT >= 21)
    {
      ...
      this.a = paramContext.getDrawable(k.ActionBar_background);
      this.b = paramContext.getDrawable(k.ActionBar_backgroundStacked);
      this.j = paramContext.getDimensionPixelSize(k.ActionBar_height, -1);
      if (getId() == f.split_action_bar)
      {
        this.d = true;
        this.c = paramContext.getDrawable(k.ActionBar_backgroundSplit);
      }
  ...
  public void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    label172: for (paramInt2 = View.MeasureSpec.getSize(k); ; paramInt2 = 2147483647)
    {
  ...
  public void setTabContainer(bk parambk)
  {
    if (this.g != null)
      removeView(this.g);
    this.g = parambk;
    ...
    {
      addView(parambk);
      ViewGroup.LayoutParams localLayoutParams = parambk.getLayoutParams();
      localLayoutParams.width = -1;
      localLayoutParams.height = -2;
      parambk.setAllowCollapse(false);
    }
  }
