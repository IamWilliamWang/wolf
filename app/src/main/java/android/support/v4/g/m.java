  ...
  private void e(int paramInt)
  {
    ...
    while (true)
    {
      try
      {
        ...
        d = (Object[])(Object[])arrayOfObject1[0];
        this.f = ((int[])(int[])arrayOfObject1[1]);
      ...
      try
      {
        if (b != null)
        {
          ...
          b = (Object[])(Object[])arrayOfObject2[0];
          this.f = ((int[])(int[])arrayOfObject2[1]);
 ...
 * Qualified Name:     android.support.v4.g.m
