  ...
  implements i, Filterable
{
  ...
  public e(Context paramContext, Cursor paramCursor, boolean paramBoolean)
  {
    if (paramBoolean);
    for (int j = 1; ; j = 2)
    {
  ...
  public native abstract View a(Context paramContext, Cursor paramCursor, ViewGroup paramViewGroup);
  ...
  void a(Context paramContext, Cursor paramCursor, int paramInt)
  {
    ...
    for (this.g = new g(this, null); ; this.g = null)
    {
      if (bool)
      {
        if (this.f != null)
  ...
  public native abstract void a(View paramView, Context paramContext, Cursor paramCursor);
