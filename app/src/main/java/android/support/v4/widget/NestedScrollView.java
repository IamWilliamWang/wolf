  ...
  implements ay, ba
{
  ...
  private View a(boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    while (true)
    {
      ...
      i2 = 0;
      break label87;
      label115: if (((paramBoolean) && (i4 < localObject2.getTop())) || ((!paramBoolean) && (i6 > localObject2.getBottom())));
      for (i4 = 1; ; i4 = 0)
      {
        if (i1 == 0)
          break label170;
  ...
  private void a(MotionEvent paramMotionEvent)
  {
    ...
    if (ap.b(paramMotionEvent, i1) == this.q)
      if (i1 != 0)
        break label63;
    label63: for (i1 = 1; ; i1 = 0)
    {
      this.f = (int)ap.d(paramMotionEvent, i1);
      this.q = ap.b(paramMotionEvent, i1);
      if (this.k != null)
        this.k.clear();
      return;
    }
  ...
  boolean a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8, boolean paramBoolean)
  {
    ...
    if (computeHorizontalScrollRange() > computeHorizontalScrollExtent())
    {
      ...
      if (computeVerticalScrollRange() <= computeVerticalScrollExtent())
        break label194;
      i2 = 1;
      label34: if ((i3 != 0) && ((i3 != 1) || (i1 == 0)))
        break label200;
      i1 = 1;
      label53: if ((i3 != 0) && ((i3 != 1) || (i2 == 0)))
        break label206;
      i2 = 1;
      label72: paramInt1 = paramInt3 + paramInt1;
      if (i1 == 0)
        paramInt7 = 0;
    ...
    while (true)
    {
      ...
      while (true)
      {
        ...
        if ((paramBoolean) || (bool))
        {
          ...
          label206: i2 = 0;
          break label72;
          label212: if (paramInt1 >= paramInt4)
            break label248;
          paramBoolean = true;
          paramInt1 = paramInt4;
          break label132;
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    if (this.d != null)
    {
      ...
      if (!this.e.a())
      {
        ...
        int i5 = getHeight();
        paramCanvas.translate(-i3 + getPaddingLeft(), Math.max(getScrollRange(), i1) + i5);
  ...
  {
    if ((ap.c(paramMotionEvent) & 0x2) != 0)
    ...
    while (true)
    {
      ...
      if (this.j)
        continue;
      float f1 = ap.e(paramMotionEvent, 9);
      if (f1 == 0.0F)
        continue;
  ...
  public boolean onInterceptTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    while (true)
    {
      ...
      this.f = i1;
      this.q = ap.b(paramMotionEvent, 0);
      c();
      this.k.addMovement(paramMotionEvent);
      this.c.f();
      if (!this.c.a())
  ...
  {
    paramParcelable = (w)paramParcelable;
  ...
  {
    w localw = new w(super.onSaveInstanceState());
    localw.a = getScrollY();
    return localw;
  }
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    while (this.j)
    {
      ...
      if (i2 < 0)
      {
        this.d.a(i1 / getHeight(), ap.c(paramMotionEvent, i3) / getWidth());
        if (!this.e.a())
          this.e.b();
      }
      while ((this.d != null) && ((!this.d.a()) || (!this.e.a())))
      {
        ...
        if (i2 <= i4)
          continue;
        this.e.a(i1 / getHeight(), 1.0F - ap.c(paramMotionEvent, i3) / getWidth());
        if (this.d.a())
          continue;
        this.d.b();
      }
      if (this.j)
      {
        ...
        i1 = (int)bd.a(paramMotionEvent, this.q);
      ...
      f();
      break;
      i1 = ap.b(paramMotionEvent);
      this.f = (int)ap.d(paramMotionEvent, i1);
      this.q = ap.b(paramMotionEvent, i1);
      break;
      a(paramMotionEvent);
      this.f = (int)ap.d(paramMotionEvent, ap.a(paramMotionEvent, this.q));
      break;
    }
  }
  ...
  public void setOnScrollChangeListener(v paramv)
  {
    this.A = paramv;
  }
