...
{
  private static final android.support.v4.g.m<String, Class<?>> Z = new android.support.v4.g.m();
  ...
  public static m a(Context paramContext, String paramString, Bundle paramBundle)
  {
    try
    {
      ...
      paramContext = (m)localClass1.newInstance();
      if (paramBundle != null)
      {
    ...
    {
      throw new n("Unable to instantiate fragment " + paramString + ": make sure class name exists, is public, and has an" + " empty constructor that is public", paramContext);
    }
  ...
  static boolean b(Context paramContext, String paramString)
  {
    try
    {
      ...
      boolean bool = m.class.isAssignableFrom(localClass1);
      return bool;
    }
    catch (java.lang.ClassNotFoundException paramContext)
    {
  ...
  final void a(int paramInt, m paramm)
  {
    this.g = paramInt;
    if (paramm != null)
    {
      this.h = (paramm.h + ":" + this.g);
      return;
    }
  ...
  public LayoutInflater b(Bundle paramBundle)
  {
    ...
    d();
    android.support.v4.h.r.a(paramBundle, this.u.s());
    return paramBundle;
  }
  ...
  {
    this.u = new w();
    this.u.a(this.t, new r()
    {
      public View a(int paramInt)
      {
        if (m.this.I == null)
          throw new IllegalStateException("Fragment does not have a view");
        return m.this.I.findViewById(paramInt);
      }
