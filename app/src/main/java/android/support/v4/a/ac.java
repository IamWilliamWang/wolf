...
class ac
{
  ...
  private static void a(Transition paramTransition, ad paramad)
  {
    if (paramTransition != null)
      paramTransition.setEpicenterCallback(new Transition.EpicenterCallback(paramad)
      {
        private Rect b;
  ...
  {
    ((Transition)paramObject).setEpicenterCallback(new Transition.EpicenterCallback(c(paramView))
    {
      public Rect onGetEpicenter(Transition paramTransition)
      {
        return ac.this;
  ...
  public static void a(Object paramObject1, Object paramObject2, View paramView1, ae paramae, View paramView2, ad paramad, Map<String, String> paramMap, ArrayList<View> paramArrayList1, Map<String, View> paramMap1, Map<String, View> paramMap2, ArrayList<View> paramArrayList2)
  {
    if ((paramObject1 != null) || (paramObject2 != null))
    {
      ...
      if (paramae != null)
        paramView1.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener(paramView1, paramObject1, paramView2, paramae, paramMap, paramMap2, paramArrayList1)
        {
          public boolean onPreDraw()
          {
            ac.this.getViewTreeObserver().removeOnPreDrawListener(this);
 ...
 * Qualified Name:     android.support.v4.a.ac
