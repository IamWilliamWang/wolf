  ...
  implements Animatable
{
  ...
  private final Drawable.Callback e = new Drawable.Callback()
  {
    ...
    {
      b.this.scheduleSelf(paramRunnable, paramLong);
    }

    public void unscheduleDrawable(Drawable paramDrawable, Runnable paramRunnable)
    {
      b.this.unscheduleSelf(paramRunnable);
    }
  };
  ...
  private b(Context paramContext, c paramc, Resources paramResources)
  {
    this.c = paramContext;
    if (paramc != null)
    {
    ...
    this.b = new c(paramContext, paramc, this.e, paramResources);
  }
  ...
  public void inflate(Resources paramResources, XmlPullParser paramXmlPullParser, AttributeSet paramAttributeSet, Resources.Theme paramTheme)
  {
    ...
    if (i != 1)
      if (i == 2)
      {
        ...
        if (i != 0)
        {
          localObject2 = j.a(paramResources, i, paramTheme);
          ((j)localObject2).a(false);
          ((j)localObject2).setCallback(this.e);
          if (this.b.b != null)
            this.b.b.setCallback(null);
          this.b.b = ((j)localObject2);
        }
    ...
    while (true)
    {
      ...
      break label28;
      break;
      label156: if (!"target".equals(localObject1))
        continue;
    ...
    label229: throw new IllegalStateException("Context can't be null when inflating animators");
  }
