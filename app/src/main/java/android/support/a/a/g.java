...
public class g
{
  ...
  private g(char paramChar, float[] paramArrayOfFloat)
  {
    this.a = paramChar;
  ...
  {
    this.a = paramg.a;
    this.b = e.a(paramg.b, 0, paramg.b.length);
  }
  ...
  private static void a(Path paramPath, float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, float paramFloat5, float paramFloat6, float paramFloat7, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    while (true)
    {
      ...
      d2 -= d11;
      break;
      label427: paramBoolean1 = false;
      break label325;
      label433: d1 = d4 + 6.283185307179586D;
    }
  }
    ...
    while (true)
    {
      ...
      while (true)
      {
        ...
        while (true)
        {
          ...
          {
            bool1 = true;
            label1974: if (paramArrayOfFloat2[(paramChar1 + '\004')] == 0.0F)
              break label2068;
          }
          label2068: for (boolean bool2 = true; ; bool2 = false)
          {
          ...
          {
            bool1 = true;
            label2129: if (paramArrayOfFloat2[(paramChar1 + '\004')] == 0.0F)
              break label2211;
          }
          label2211: for (bool2 = true; ; bool2 = false)
          {
  ...
  public static void a(g[] paramArrayOfg, Path paramPath)
  {
    ...
    {
      a(paramPath, arrayOfFloat, c, paramArrayOfg[i].a, paramArrayOfg[i].b);
      c = paramArrayOfg[i].a;
      i += 1;
    }
  }
 ...
 * Qualified Name:     android.support.a.a.g
